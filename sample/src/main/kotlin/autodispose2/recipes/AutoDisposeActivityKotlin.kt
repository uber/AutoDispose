...
import autodispose2.recipes.AutoDisposeActivityKotlin.ActivityEvent
import autodispose2.recipes.AutoDisposeActivityKotlin.ActivityEvent.CREATE
import autodispose2.recipes.AutoDisposeActivityKotlin.ActivityEvent.DESTROY
import autodispose2.recipes.AutoDisposeActivityKotlin.ActivityEvent.PAUSE
import autodispose2.recipes.AutoDisposeActivityKotlin.ActivityEvent.RESUME
import autodispose2.recipes.AutoDisposeActivityKotlin.ActivityEvent.START
import autodispose2.recipes.AutoDisposeActivityKotlin.ActivityEvent.STOP
import io.reactivex.rxjava3.core.Observable
import io.reactivex.rxjava3.subjects.BehaviorSubject

/**
 * An [Activity] example implementation for making one implement [LifecycleScopeProvider]. One would
 * normally use this as a base activity class to extend others from.
 */
abstract class AutoDisposeActivityKotlin : Activity(), LifecycleScopeProvider<ActivityEvent> {
  ...
  companion object {
    ...
    private val CORRESPONDING_EVENTS =
      CorrespondingEventsFunction<ActivityEvent> { activityEvent ->
        when (activityEvent) {
          CREATE -> DESTROY
          START -> STOP
          RESUME -> PAUSE
