...
/**
 * Copy of the MainThreadDisposable from RxAndroid which makes use of {@link
 * AutoDisposeAndroidUtil#isMainThread()}. This allows disposing on the JVM without crashing due to
